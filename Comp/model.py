...
class Image_net(nn.Module):
    def __init__(self, embedding_dim, outfit_threshold, att_num_dic={}):
        ...
        self.backbone.fc = torch.nn.Linear(512, embedding_dim) #resnret18
        ...
        #=========================== partial supervision ===========================
        att_num_list = [13, 4, 5181, 62, 21, 38, 16, 24, 7, 4, 5]  # 11 attributes
    ...
    def overview_graph(self, attr_graph_feature,item_graph_feature,img_feature, mask):   
        ...
        # item_graph_feature: 12, batch_size, 10, 64
